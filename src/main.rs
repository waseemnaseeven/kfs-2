...
*/
const KERNEL_CODE_SELECTOR: u16 = 1 << 3; // 1 << 3 = 0b0000_1000 = 8, privilege 0 kernel 
...
#[allow(dead_code)]
const USER_STACK_SELECTOR: u16 = (6 << 3) | 0b11;
...
unsafe fn load_gdt_and_segments(
    ...
    // Stack is defined in the boot assembly; reuse it once the new SS descriptor is active.
